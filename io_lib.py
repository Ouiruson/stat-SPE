...
# lecture et à l'écritude de données
# Dernière mise à jour: 15/09/2016
# ==============================================================================

# ==============================================================================
# Les fonctions de la bibliothèque io_lib sont les suivantes:
# lec_tab2_tsv: lecture d'un tableau 2D dans un fichier texte *.tsv. 
#               La première ligne du fichier décrit le nom des
#               variables et la première colonne le nom des individus.
# lec_tab2_csv: lecture d'un tableau 2D dans un fichier csv. 
#               La première ligne du fichier décrit le nom des
#               variables et la première colonne le nom des individus.
# ==============================================================================
...
## ==============================================================================
#function stemplot(X,varargin)
## ==============================================================================
## tracé en baton d'un vecteur X
## second argument: ind_freq = %T/%F (par defaut %T);
## ==============================================================================
